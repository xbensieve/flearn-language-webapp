import { Brain, MessageCircle, Target, Trophy } from 'lucide-react';
      ...
      <div className="container max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="flex items-center justify-center flex-col text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto font-light">
            Các tính năng đột phá được thiết kế riêng để{' '}
            <span className="font-semibold text-sky-600">tăng tốc độ</span> và làm cho hành trình
            chinh phục ngoại ngữ của bạn trở nên dễ dàng hơn bao giờ hết.
          </p>
        </div>

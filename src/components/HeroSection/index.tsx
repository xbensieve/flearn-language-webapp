...
const HeroSection = () => {
  return (
    <section className='relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-sky-50 via-sky-100 to-blue-100'>
      ...
      <div className='container mx-auto px-4 py-20 pb-45 mt-24 relative z-10'>
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='space-y-8 animate-fade-in'>
            ...
            <p className='text-xl text-gray-700 leading-relaxed max-w-xl'>
              Learn languages the way they're meant to be learned. Interactive lessons, real
              conversations, and AI‑powered practice that adapts to your pace.
            </p>

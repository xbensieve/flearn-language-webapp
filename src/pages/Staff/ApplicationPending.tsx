...
const ApplicationsManagement: React.FC = () => {
  ...
  const approveMutation = useMutation({
    mutationFn: (payload: { applicationId: string }) =>
      reviewApproveApplication(payload),
    onSuccess: () => {
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-center items-center gap-2 mr-6">
              ...
              <Button
                ...
                onClick={() =>
                  openRejectModal(selectedApplication?.applicationID || "")
                }
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-2">
                          {selectedApplication.language || "N/A"}
                        </span>
                      </div>
                    </div>
                  </Card>
                  ...
                  >
                    <div style={{ maxHeight: "400px", overflowY: "auto" }}>
                      {selectedApplication.certificates?.length ? (
                        ...
                        >
                          <FilePdfOutlined
                            style={{ fontSize: "48px", marginBottom: 8 }}
                          />
              ...
              >
                ...
                >
                  <Descriptions.Item label="Status">
                    <Tag
                      color={
                        statusMap[selectedApplication.status]?.color ||
                        "default"
                      }
                    >

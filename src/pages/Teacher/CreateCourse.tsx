...
const CreateCourse: React.FC = () => {
    ...
    onError: (err: AxiosError<any>) => {
      ...
      if (errorData?.errors) {
        if (Array.isArray(errorData?.errors)) {
          errorData?.errors.forEach((msg: any) => notifyError(`${msg}`));
        }
        return;
      } else {
  ...
  const onFinish = (values: CourseFormValues) => {
    const payload: CreateCourseRequest = {
      ...
      gradingType:
        formValues.gradingType ||
        ((values.courseType || formValues.courseType) === 1 ? "1" : "2"),
    };
                            ...
                            {templates.map((t: any) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    {t.unitCount} units · {t.lessonsPerUnit}{" "}
                                    lessons · {t.exercisesPerLesson} exercises
                                  </span>
                                </div>
                              </Option>
                            ))}
              ...
              <Card className="bg-white !rounded-2xl shadow-lg border-0 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <Tag
                      color={
                        courseTypeWatch || formValues.courseType === 1
                          ? "green"
                          : "blue"
                      }
                    >
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {(topicIdsWatch || formValues.topicIds)
                      ?.slice(0, 3)
                      .map((id) => {

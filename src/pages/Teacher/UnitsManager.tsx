  ...
  return (
    <div className='max-w-6xl mx-auto py-8 px-4'>
      ...
      <div className='flex flex-col gap-3'>
        <Collapse activeKey={activeKey} onChange={(key) => setActiveKey(key)} className='mb-6'>
          <Panel
          ...
          >
            ...
            >
              ...
              <div className='flex justify-end'>
                <Button type='primary' htmlType='submit' loading={createLessonMutation.isPending}>
                  Save Lesson
                </Button>
              </div>
            </Form>
        ...
        <LessonsList unit={unit} onEditLesson={(lesson) => console.log('Edit', lesson)} />
      </div>
    </div>
  );
};
      ...
      {lessons.map((lesson, index) => {
        ...
        return (
          ...
          >
                ...
                <div className='flex justify-between items-center w-full my-1.5'>
                  <div className='flex flex-col'>
                    <div className='flex items-center gap-2'>
                      ...
                      <Tag color='blue-inverse' className='rounded-md text-xs'>
                        #{lesson.position}
                      </Tag>
                    </div>
            ...
            >
              {isEditing ? (
                <Form form={form} layout='vertical' onFinish={() => handleSaveEdit(lesson)}>
                  <Form.Item
                    name='title'
                    label='Lesson Title'

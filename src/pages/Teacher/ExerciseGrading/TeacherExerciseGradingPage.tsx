...
const TranslateGradeStatus: Record<string, string> = {
  Assigned: "Đang chờ chấm",
  Returned: "Đã chấm xong",
  Expired: "Hết hạn",
  Reassigned: "Được giao lại",
};

const TranslateEarningStatus: Record<string, string> = {
  Approved: "Hoàn thành",
  Rejected: "Không hoàn thành",
  ...
  const handleSubmitGrade = async () => {
    ...
    if (!gradingFeedback.trim()) {
      toast.error("Cần có phản hồi", {
        description: "Vui lòng nhập phản hồi cho học viên.",
      });
      return;
    }
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      <Badge variant="secondary" className="mt-1 text-[10px]">
                        {TranslateExerciseType[item.exerciseType]}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex flex-col items-center leading-none">
                        <Badge
                          ...
                          variant="outline"
                        >
                          {TranslateGradeStatus[item.status] || item.status}
                        </Badge>
              ...
              <>
                <SheetHeader className="mb-6">
                  <SheetTitle className="text-xl leading-6">
                    {TranslateExerciseType[selectedAssignment.exerciseType]}
                  </SheetTitle>
                  <SheetDescription>
                ...
                <div className="space-y-6">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-red-800 text-sm">
                            Bài tập đã được giao lại
                          </h4>
                          <p className="text-sm text-red-700 mt-1">
                            Bài tập này đã được bạn giao lại cho giáo viên khác
                            để chấm điểm. Bạn không thể chấm bài tập này nữa.
                          </p>
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-slate-50 border border-slate-200">
                      <div className="flex flex-col">
                        ...
                        <span className="font-medium text-slate-800">
                          {TranslateGradeStatus[selectedAssignment.status] ||
                  ...
                  <div className="p-4 rounded-lg border border-emerald-100 bg-emerald-50/50">
                    <h4 className="text-sm font-semibold text-emerald-800 flex items-center gap-2 mb-3">
                      <Wallet className="h-4 w-4" /> Thông tin thu nhập
                    </h4>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-white p-3 rounded border border-emerald-100">
                        ...
                        <div className="text-lg font-bold text-emerald-600 flex items-center"></div>
                        <Badge
                          variant="outline"
                    ...
                    {selectedAssignment.earningStatus === "Rejected" && (
                      <p className="text-xs text-red-500 mt-2 italic">
                        * Lưu ý: Thu nhập của bài tập này đã được chuyển nhượng
                        cho bên khác hoặc đã bị tạm giữ do quá hạn.
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-800 flex items-center gap-2 mb-3">
                      <Trophy className="h-4 w-4 text-yellow-600" /> Kết quả
                      chấm điểm
                    </h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      <h4 className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                        <Award className="h-4 w-4" /> Điểm đạt yêu cầu
                      </h4>
                      <p className="font-medium">
                        {selectedAssignment.passScore || "--"} / 100
                      </p>
                  ...
                  <div>
                    ...
                    {selectedAssignment.audioUrl ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">
                        Học viên chưa tải lên bài nói nào.
                      </p>
                    )}
                  </div>
                  <Separator />
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                      <Award className="h-4 w-4" /> Phản hồi và điểm số AI
                    </h4>
                    {(() => {
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {!isGradingMode &&
                          selectedAssignment.status === "Assigned" && (
                            ...
                            >
                              <Edit3 className="mr-2 h-4 w-4" /> Chấm bài
                            </Button>
                          )}
                      </div>
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-4 animate-in fade-in zoom-in-95 duration-200">
                          ...
                          {selectedAssignment.status === "Returned" && (
                            <div className="bg-green-100 text-green-800 text-xs px-3 py-2 rounded flex items-center gap-2">
                              <CheckCircle2 className="h-4 w-4" />
                              Bài tập này đã được chấm và trả lại cho học viên.
                            </div>
                          )}
                        </div>
                      )}

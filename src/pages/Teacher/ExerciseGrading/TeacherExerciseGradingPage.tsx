...
export default function TeacherExerciseGradingPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await exerciseGradingService.getTeacherAssignments(queryParams);
  ...
  const handleSubmitGrade = async () => {
    ...
    try {
      ...
      // Gọi API
      await exerciseGradingService.submitGrade(selectedAssignment.exerciseSubmissionId, {
        score: scoreNum,
      ...
      const msg = error?.response?.data?.message || 'Nộp điểm thất bại';
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Quản lý chấm bài tập</h2>
                  ...
                  <TableRow
                    ...
                    <TableCell className="text-sm">
                      <div className="flex flex-col gap-1">
                        ...
                        <span
                          className={`text-xs ${item.isOverdue ? 'text-red-600 font-bold' : ''}`}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-lg border border-emerald-100 bg-emerald-50/50">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white p-3 rounded border border-emerald-100">
                        <div className="text-xs text-muted-foreground">Số tiền kiếm được</div>
                      ...
                      <div className="bg-white p-3 rounded border border-emerald-100">
                        <div className="text-xs text-muted-foreground">Trạng thái thu nhập</div>
                        <Badge
                          variant="outline"
                          className={`mt-1 ${getEarningColor(selectedAssignment.earningStatus)}`}>
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-800 flex items-center gap-2 mb-3">
                      <Trophy className="h-4 w-4 text-yellow-600" /> Điểm cuối cùng & Kết quả
                    </h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="font-medium">{selectedAssignment.passScore || '--'} / 100</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {selectedAssignment.audioUrl ? (
                      ...
                      <p className="text-sm text-muted-foreground italic">No audio submitted.</p>
                    )}
                  </div>
                      ...
                      if (!aiData) {
                        return (
                          <div className="bg-slate-50 p-4 rounded-md border text-sm">
                            <span className="font-semibold text-slate-600">Trạng thái AI: </span>
                      ...
                      return (
                        <div className="bg-white rounded-md border p-4 space-y-3">
                          <div className="flex justify-between items-center pb-2 border-b">
                            <span className="font-semibold text-sm">Điểm tổng thể AI:</span>
                            <Badge className="bg-blue-600">{aiData.overall}/100</Badge>
                          </div>
                  ...
                  {selectedAssignment && !selectedAssignment.isReassigned && (
                    <div className="mt-6 pt-6 border-t border-slate-200">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {!isGradingMode && selectedAssignment.status !== 'Returned' && (
                          <Button
                            size="sm"
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              <Input
                                ...
                                disabled={isSubmitting || selectedAssignment.status === 'Returned'}
                                className={`pr-12 font-semibold text-lg ${
                                  parseFloat(gradingScore) > 100 || parseFloat(gradingScore) <= 0
                          ...
                          {selectedAssignment.status !== 'Returned' && (
                            <div className="flex gap-3 pt-2">
                              <Button
                                ...
                                <X className="mr-2 h-4 w-4 cursor-pointer" /> Thoát
                              </Button>
                              <Button

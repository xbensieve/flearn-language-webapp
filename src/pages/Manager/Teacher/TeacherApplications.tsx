    ...
    const config: Record<string, { color: string; icon: any; label?: string }> =
      {
        Approved: {
          color:
            "bg-emerald-100 text-emerald-700 border-emerald-200 hover:bg-emerald-200 justify-center",
          icon: CheckCircle2,
          label: "Đã duyệt",
        },
        Pending: {
          color:
            "bg-amber-100 text-amber-700 border-amber-200 hover:bg-amber-200 justify-center",
          icon: Clock,
          label: "Đang chờ duyệt",
        },
        Rejected: {
          color:
            "bg-rose-100 text-rose-700 border-rose-200 hover:bg-rose-200 justify-center",
          icon: XCircle,
          label: "Từ chối",
        },
      };

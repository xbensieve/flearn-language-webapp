            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div className="flex items-center space-x-4">
                        ...
                        <Title level={2} className="!mb-0 bg-gradient-to-r from-red-600 to-pink-700 bg-clip-text text-transparent">
                            Quản lý hoàn tiền
                        </Title>
                        <Badge count={refunds.length} style={{ backgroundColor: '#52c41a' }} />
                    </div>
                ...
                {refunds.length > 0 ? (
                    <Row gutter={[24, 24]}>
                        {refunds.map((refund) => {
                            ...
                            return (
                                <Col key={refund.refundRequestId} xs={24} sm={12} lg={8}>
                                    <Card
                                        hoverable
                                    ...
                                    >
                                        <div className="p-4">
                                            <div className="flex justify-between items-start mb-3">
                                                <Title level={4} className="text-gray-800 mb-0 line-clamp-1">
                                                    {refund.studentName}
                                                </Title>
                ...
                >
                    <Form form={createForm} layout="vertical">
                        ...
                        >
                            <Input.TextArea rows={4} placeholder="VD: Học viên bận đột xuất, không tham gia được" />
                        </Form.Item>
                    </Form>
                </Drawer>
                ...
                <Modal
                    ...
                    width={600}
                >
                    <Form form={form} layout="vertical" onFinish={handleProcessRefund} initialValues={{ action: 'Approve' }}>
                        {selectedRefund && (
                        ...
                        >
                            <Input.TextArea rows={4} placeholder="VD: Đã chuyển 500k qua Momo lúc 14:30" />
                        </Form.Item>
